...
export default async function handler(req,res){
  ...
  catch(error){console.error('ERP_TRACKING_ALERTS_ERROR',error);return fail(res,upstreamFailureStatus(error,500),'No se pudieron comprobar las actualizaciones del tracking ERP');}
}
