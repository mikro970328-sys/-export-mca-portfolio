...
function cleanLines(lines){
  ...
  return lines.map((line,index)=>{
    ...
    return {id:text(line.id,80)||null,product_id:productId,ordered_quantity:text(line.ordered_quantity,80),ordered_pallets:text(line.ordered_pallets,80),units_per_pallet:text(line.units_per_pallet,80),unit_cost:text(line.unit_cost,80),line_total:text(line.line_total,80),notes:text(line.notes,1000)};
  });
}
