...
La PR #289 está publicada en el commit `55c6ae255b7abcd26068b941f0bc7c43c9f7d1d4`, producción `dpl_4pshzRmzZGJmzntku1i5K8mz4KYG` READY. Corrige permisos obsoletos en módulos embebidos y diálogos móviles cubiertos por el encabezado. El candidato aprobó 20/20 escenarios y 52/52 workflows (`34401479844`); en main volvieron a aprobar Browser Operator Acceptance `34402916794` y Operator and Concurrency Acceptance `34402917038`, ambos con sus dos jobs. PWA y live7 responden 200; API de versiones sin sesión, 401. Matriz: `docs/BROWSER_OPERATOR_ACCEPTANCE.md`. La caída BadgeService del headless shell reducido está resuelta usando Chromium completo; no es un fallo de sesión del ERP.
