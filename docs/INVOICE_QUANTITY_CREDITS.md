...
No implementa cambio de precio, documento fiscal local ni
envío automático al cliente. La continuación de devolución/aplicación del saldo
se documenta en INVOICE_CREDIT_SETTLEMENT.md. Los reversos de notas se describen
en INVOICE_CREDIT_REVERSALS.md.
