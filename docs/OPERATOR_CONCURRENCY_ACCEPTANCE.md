...
- Main volvió a aprobar ambos jobs aislados en el [run 34401420872](https://github.com/mikro970328-sys/-export-mca-portfolio/actions/runs/34401420872). El workflow iPhone externo `34401420975` falló aparte por cuota `Automate testing time expired`; su contrato estático aprobó. La suite aislada se excluye de la configuración BrowserStack para que nunca se ejecute contra producción ni consuma minutos de dispositivo.
