...
requireText(index, "/admin/navigation-shell.css?v=20260909-viewport1", 'CSS versionado del shell');
requireText(index, "/admin/platform-theme.css?v=20260909-viewport1", 'sistema visual versionado');
requireText(index, "/admin/erp.js?v=20260905-accessflow1", 'loader versionado del shell visual');
requireText(erp, "/admin/access-control-administration.js?v=20260905-accessflow1", 'owner versionado de Usuarios y acceso');
