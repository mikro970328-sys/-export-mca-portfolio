...
requireText(index, "/admin/erp.js?v=20260926-integration1", 'loader versionado del shell visual');
requireText(erp, "/admin/access-control-administration.js?v=20260926-figma2", 'owner versionado de Usuarios y acceso');
