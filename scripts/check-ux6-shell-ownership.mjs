...
requireText(index, "/admin/navigation-shell.css?v=20260903-ux7icons1", 'CSS versionado del shell');
requireText(index, "/admin/platform-theme.css?v=20260902-ux7shell1", 'sistema visual versionado');
requireText(index, "/admin/erp.js?v=20260903-ux7icons1", 'loader versionado del shell visual');
