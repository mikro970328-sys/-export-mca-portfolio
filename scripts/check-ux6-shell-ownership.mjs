...
requireText(index, "/admin/navigation-shell.css?v=20260921-ux8contrast1", 'CSS versionado del shell');
requireText(index, "/admin/platform-theme.css?v=20260909-viewport1", 'sistema visual versionado');
requireText(index, "/admin/erp.js?v=20260921-ux8contrast1", 'loader versionado del shell visual');
