...
for(const fragment of ["id:'reportsSection'","src:'/admin/reports.html?embedded=1&v=20260926-figma1'","permission:'reports.read'","sections:['invoicesSection','payablesSection','costsSection','reportsSection']","openReports: () => openEmbeddedById('reportsSection')"]){
