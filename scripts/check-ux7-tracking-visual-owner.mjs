...
for(const text of [
  "loadStylesheet('/admin/containers-module.css?v=20260926-figma1', 'data-containers-module-style')",
  "loadScript('/admin/containers-module.js?v=20260926-figma1', 'data-containers-module')",
...
requireText(html,'/admin/erp.js?v=20260926-integration1','revisión de caché del ERP');
