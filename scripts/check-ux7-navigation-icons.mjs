...
for (const fragment of [
  ...
  "loadScript('/admin/navigation-shell.js?v=20260910-startup1', 'data-navigation-shell')",
  "loadScript('/admin/tasks-workspace.js?v=20260915-taskvisibility1', 'data-tasks-workspace')",
  ...
  "loadScript('/admin/dashboard-operational-state.js?v=20260909-finance1', 'data-dashboard-operational-state')"
