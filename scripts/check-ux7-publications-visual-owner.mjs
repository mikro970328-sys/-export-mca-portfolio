...
for (const text of [
  '<link rel="stylesheet" href="/admin/publications.css?v=20260926-figma2">',
  ...
  '<script src="/admin/publications.js?v=20260926-figma2" defer></script>',
...
const ownerCssIndex = html.indexOf('/admin/publications.css?v=20260926-figma2');
