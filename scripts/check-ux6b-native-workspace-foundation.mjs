...
const navigationIndex=index.indexOf('/admin/navigation-shell.css?v=20260902-ux7shell1');
...
requireText(index,'/admin/erp.js?v=20260903-ux7payables1','revisión de caché del loader ERP');
