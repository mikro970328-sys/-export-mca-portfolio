...
const themeIndex=index.indexOf('/admin/platform-theme.css?v=20260902-ux6b1');
const navigationIndex=index.indexOf('/admin/navigation-shell.css?v=20260902-ux6b1');
...
requireText(index,'/admin/erp.js?v=20260902-ux6alerts2','revisión de caché del loader ERP');
