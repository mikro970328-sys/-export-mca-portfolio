...
const themeIndex=index.indexOf('/admin/platform-theme.css?v=20260922-figma1');
const navigationIndex=index.indexOf('/admin/navigation-shell.css?v=20260926-integration1');
...
requireText(index,'/admin/erp.js?v=20260926-integration1','revisión de caché del loader ERP');
...
for(const ref of [
  ...
  "/admin/access-control-administration.js?v=20260926-figma2",
