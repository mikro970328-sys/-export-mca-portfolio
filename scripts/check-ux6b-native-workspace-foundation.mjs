...
const navigationIndex=index.indexOf('/admin/navigation-shell.css?v=20260921-ux8clarity1');
...
requireText(index,'/admin/erp.js?v=20260921-ux8clarity1','revisión de caché del loader ERP');
