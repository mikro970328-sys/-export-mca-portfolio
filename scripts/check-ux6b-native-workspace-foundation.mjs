...
const navigationIndex=index.indexOf('/admin/navigation-shell.css?v=20260922-figma1');
...
requireText(index,'/admin/erp.js?v=20260926-figma8','revisión de caché del loader ERP');
