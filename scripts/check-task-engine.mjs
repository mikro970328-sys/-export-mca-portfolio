...
if(files.every(file=>fs.existsSync(path.join(root,file)))) {
  ...
  for(const required of [
    ...
    '/admin/navigation-shell.js?v=20260903-ux7icons1',
    '/admin/section-state.js?v=20260817-nav1'
  ]) if(!loader.includes(required))failures.push(`admin/erp.js: falta ${required}`);
  const navIndex=loader.indexOf('/admin/navigation-shell.js?v=20260903-ux7icons1');
  const taskIndex=loader.indexOf('/admin/tasks-workspace.js?v=20260903-ux7icons1');
