...
assert(erp.includes("loadStylesheet('/admin/dashboard-executive.css?v=20260921-ux8contrast1'"), 'P11: bootstrap no carga stylesheet dashboard');
assert(erp.includes("loadScript('/admin/dashboard-operational-state.js?v=20260921-ux8clarity1'"), 'P11: bootstrap no carga owner P11');
