...
async function load(){const d=await api('/api/sales');orders=d.orders||[];clients=d.clients||[];importers=d.importers||[];clientImporters=d.client_importers||[];products=d.products||[];writeAccess=d.write_access===true;$('newOrder').hidden=!writeAccess;fillMasters();render()}
