(() => {
  ...
  function installStyles() {
    ...
    style.textContent=`
      ...
      .container-mode{display:block;margin-top:5px;font-size:11px;color:#667085}.container-mode.manual{color:#9a6700}.container-mode.failed{color:#b42318}.container-unassigned-row{background:#fffaf0}.container-client-unassigned{display:inline-block;padding:5px 9px;border-radius:999px;background:#fff0c7;color:#8a5700;font-size:11px;font-weight:900}.container-sale-note{display:block;margin-top:4px;color:#9a6700;font-size:10px;font-weight:700}.container-importer-pill{display:inline-flex;padding:5px 8px;border-radius:999px;background:#fff3e8;color:#9b4a00;font-size:11px;font-weight:800}.container-importer-help{font-size:11px;color:var(--muted);margin-top:5px;line-height:1.45}
      .container-list-footer{display:flex;justify-content:flex-end;padding:12px 4px 2px;color:#667085;font-size:12px;font-weight:800}.container-doc-state{display:inline-flex;padding:5px 8px;border-radius:999px;font-size:11px;font-weight:900;white-space:nowrap}.container-doc-state.ready{background:#edf9f0;color:#117a37}.container-doc-state.pending{background:#fff4df;color:#9a6700}.container-doc-state.idle{background:#f2f4f7;color:#667085}.container-doc-state.restricted{background:#f2f4f7;color:#667085}
      ...
      .container-customs{grid-column:1/-1;margin-top:20px;padding-top:16px;border-top:1px solid #dfe5ee}.container-customs-head{display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:12px}.container-customs-head h3{margin:0;color:#06204a}.container-customs-summary{margin-top:5px;color:#667085;font-size:12px}.container-customs-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.container-customs-card{border:1px solid #dfe5ee;border-radius:12px;padding:14px;background:#fff}.container-customs-card.complete{border-color:#a8d7b3;background:#f7fcf8}.container-customs-card.pending{border-color:#f0cf8a;background:#fffaf1}.container-customs-title{display:flex;align-items:center;justify-content:space-between;gap:10px}.container-customs-title b{color:#06204a}.container-customs-meta{margin-top:7px;font-size:11px;color:#667085}.container-customs-actions{display:flex;gap:7px;flex-wrap:wrap;margin-top:12px}.container-customs-note{grid-column:1/-1;padding:11px 12px;border-radius:10px;background:#f4f7fb;color:#475467;font-size:12px;line-height:1.45}.container-customs-feedback{grid-column:1/-1;min-height:18px;font-size:12px;font-weight:700}.container-customs-feedback.ok{color:#117a37}.container-customs-feedback.bad{color:#b42318}.container-customs-versions{margin-top:12px;padding-top:10px;border-top:1px solid #e6ebf2}.container-customs-versions-title{font-size:10px;font-weight:900;text-transform:uppercase;color:#667085;margin-bottom:7px}.container-customs-version-list{display:grid;gap:6px}.container-customs-version{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:8px;border:1px solid #e6ebf2;border-radius:8px;background:#fff}.container-customs-version-main{min-width:0}.container-customs-version-main b{font-size:11px;color:#344054}.container-customs-version-main small{display:block;margin-top:2px;color:#667085;font-size:10px;white-space:normal;word-break:break-word}.container-customs-version-state{display:inline-flex;padding:3px 6px;border-radius:999px;font-size:9px;font-weight:900;text-transform:uppercase;white-space:nowrap;background:#f2f4f7;color:#667085}.container-customs-version-state.superseded{background:#f2f4f7;color:#475467}.container-customs-version-state.deleted{background:#fef3f2;color:#b42318}.container-customs-noaccess{grid-column:1/-1;padding:12px;border:1px solid #dfe5ee;border-radius:10px;background:#f8fafc;color:#667085;font-size:12px}
      .customs-confirm-overlay{position:fixed;inset:0;z-index:5600;background:rgba(16,24,40,.48);display:flex;align-items:center;justify-content:center;padding:18px}.customs-confirm-panel{width:min(460px,100%);background:#fff;border:1px solid #dfe5ee;border-radius:14px;box-shadow:0 24px 70px rgba(16,24,40,.22);padding:18px}.customs-confirm-panel h3{margin:0;color:#06204a}.customs-confirm-panel p{margin:8px 0 0;color:#667085;font-size:13px;line-height:1.5}.customs-confirm-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:18px}.customs-confirm-actions button{padding:9px 12px;font-size:12px}
      .manual-track-overlay{position:fixed;inset:0;background:rgba(3,14,31,.58);display:flex;align-items:center;justify-content:center;padding:20px;z-index:5200}.manual-track-panel{width:100%;max-width:620px;max-height:92vh;overflow:auto;background:#fff;border-radius:18px;padding:24px;box-shadow:0 18px 48px rgba(6,32,74,.25)}.manual-track-head{display:flex;justify-content:space-between;gap:12px;margin-bottom:18px}.manual-track-head h3{margin:0;color:#06204a}.manual-track-close{background:#fff!important;color:#06204a!important;border:1px solid #dfe5ee!important}.manual-track-current-box{padding:13px;border:1px solid #b8c9e4;background:#f3f7fd;border-radius:12px;margin-bottom:16px}.manual-track-list{display:grid;gap:9px;margin:14px 0 18px}.manual-track-step{position:relative;display:grid;grid-template-columns:30px 1fr;gap:10px;align-items:center;padding:11px;border:1px solid #dfe5ee;border-radius:12px;background:#fff;cursor:pointer}.manual-track-step.current{background:#f1f8f3;border-color:#b8dfc1}.manual-track-step.selected{border:2px solid #f58220;background:#fff8f2}.manual-track-step-index{width:26px;height:26px;border-radius:50%;display:grid;place-items:center;background:#edf3ff;color:#06204a;font-size:12px;font-weight:900}.manual-track-step-title{font-weight:800}.manual-track-step-note{font-size:11px;color:#667085;margin-top:2px}.manual-track-field label{display:block;margin:12px 0 6px;font-size:13px;font-weight:800}.manual-track-notify{display:grid;grid-template-columns:22px 1fr;gap:10px;align-items:start;margin-top:16px;padding:13px;border:1px solid #dfe5ee;border-radius:12px;background:#fff;cursor:pointer}.manual-track-notify.disabled{opacity:.6}.manual-track-notify input{width:18px;height:18px;margin:2px 0 0}.manual-track-notify span{display:block;color:#667085;font-size:11px;margin-top:3px}.manual-track-preview{margin-top:14px;padding:12px;border-left:4px solid #06204a;background:#f7f9fc;border-radius:8px;font-size:13px}.manual-track-preview.hidden{display:none}.manual-track-actions{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:18px}.manual-track-confirm{background:#f58220!important;padding:13px!important}.manual-track-cancel{background:#fff!important;color:#06204a!important;border:1px solid #cfd7e3!important}
      @media(max-width:760px){.container-details-grid,.container-customs-grid{grid-template-columns:1fr}.container-origin{align-items:flex-start;flex-direction:column}.container-origin button{width:100%}.container-customs-head{flex-direction:column}.container-actions-popover{left:12px!important;right:12px!important;bottom:12px!important;top:auto!important;width:auto!important}.manual-track-overlay{align-items:flex-end;padding:0}.manual-track-panel{border-radius:22px 22px 0 0;padding:22px 18px calc(22px + env(safe-area-inset-bottom))}.manual-track-actions{grid-template-columns:1fr}.container-actions-cell{position:sticky;right:0;background:#fff;z-index:2}.container-list-footer{justify-content:flex-start}.customs-confirm-overlay{align-items:flex-end;padding:0}.customs-confirm-panel{width:100%;border-radius:18px 18px 0 0;padding:18px 18px calc(18px + env(safe-area-inset-bottom))}.customs-confirm-actions{display:grid;grid-template-columns:1fr 1fr}.container-customs-version{align-items:flex-start;flex-direction:column}}
    `;
  ...
  async function loadReadiness(){
    if(!can('documents.read')){readinessByShipment=new Map();return;}
    try{
    ...
    }catch(error){ console.error('[container readiness]',error); }
  }
  async function loadImporterState(){
    try{
      const result=await request('/api/importers');
      importerState={importers:result.importers||[],client_importers:result.client_importers||[],shipment_importers:result.shipment_importers||[]};
  ...
  function ensureRegistrationImporterField(){
    ...
    const wrapper=byId('shipmentClient')?.closest('div');
    if(!wrapper) return;
    const node=document.createElement('div');
    node.id='shipmentImporterField';
    node.innerHTML='<label for="shipmentImporter">Importadora cubana</label><input id="shipmentImporter" list="shipmentImporterOptions" placeholder="Ej. Cítricos Caribe, Quimimport"><datalist id="shipmentImporterOptions"></datalist><div id="shipmentImporterHelp" class="container-importer-help">Escribe la importadora concreta de este contenedor.</div>';
  ...
  async function assignImporterToShipment(shipmentId,importerName){
    const result=await request('/api/importers',{method:'PATCH',body:JSON.stringify({action:'assign_shipment',shipment_id:shipmentId,importer_name:String(importerName||'').trim()})});
    if(result.state){importerState=result.state;window.importerState=importerState;}else await loadImporterState();
  }
  ...
  function modeLabel(shipment){ if(shipment.shipsgo_status==='manual')return ['Seguimiento manual','manual']; if(shipment.shipsgo_status==='active')return ['ShipsGo automático','']; if(shipment.shipsgo_status==='failed')return ['ShipsGo con error','failed']; return ['ShipsGo pendiente','']; }
  function docPill(readiness){
    if(!can('documents.read'))return '<span class="container-doc-state restricted">Sin acceso</span>';
  ...
  function filteredRows(){
    ...
    let list=activeFilter==='active'?rows().filter(x=>x.active!==false):activeFilter==='delivered'?rows().filter(x=>x.active===false):[...rows()];
  ...
  function render(){
    ...
    target.innerHTML=`<table><thead><tr><th>Contenedor</th><th>Cliente</th><th>Importadora</th><th>Producto</th><th>Cantidad</th><th>Fecha salida</th><th>Booking / B/L</th><th>Docs Cuba</th><th>Estado</th><th>Acciones</th></tr></thead><tbody>${list.map(shipment=>{
      const mode=modeLabel(shipment),unassigned=!shipment.client_id,importer=importerForShipment(shipment);
      const client=unassigned?'<span class="container-client-unassigned">SIN CLIENTE</span><span class="container-sale-note">Disponible para venta</span>':esc(shipment.clients?.name||'Cliente no disponible');
      return `<tr class="${unassigned?'container-unassigned-row':''}" data-shipment-row="${esc(shipment.id)}"><td><b>${esc(shipment.container_number)}</b><br><span class="muted">${esc(shipment.carrier||'')}</span></td><td>${client}</td><td>${importer?`<span class="container-importer-pill">${esc(importer.name)}</span>`:'<span class="muted">Sin definir</span>'}</td><td>${esc(shipment.product||'—')}</td><td>${esc(formatQuantity(shipment))}</td><td>${esc(formatDate(shipment.departure_date))}</td><td>${esc(shipment.booking_number||'—')}<br><span class="muted">${esc(shipment.bol_number||'—')}</span></td><td>${docPill(readinessFor(shipment.id))}</td><td><span class="pill ${shipment.active===false?'done':''}">${esc(shipment.operational_status||shipment.last_status||'Registrado')}</span><span class="container-mode ${mode[1]}">${esc(mode[0])}</span></td><td class="container-actions-cell"><button type="button" class="container-actions-trigger" data-container-menu="${esc(shipment.id)}" aria-label="Acciones" title="Acciones">⋯</button></td></tr>`;
    }).join('')}</tbody></table><div class="container-list-footer">${list.length} contenedor${list.length===1?'':'es'}${list.length!==rows().length?` visibles · ${rows().length} registrados`:''}</div>`;
  }
  ...
  async function saveShipmentRecord(){
    ...
    const clientId=byId('shipmentClient')?.value||null, importerName=String(byId('shipmentImporter')?.value||'').trim();
    const original=button.textContent; button.disabled=true; button.textContent='Guardando...'; let rollbackId=null;
    try{
      ...
      if(result.shipment?.shipsgo_status==='failed'&&confirm(`ShipsGo no pudo activar ${result.shipment.container_number}. ¿Continuar en modo manual?`)){await request('/api/tracking-mode',{method:'PATCH',body:JSON.stringify({id:result.shipment.id,action:'enable_manual'})});await window.loadAll?.();}
  ...
  function actionList(shipment){
    const status=String(shipment.operational_status||shipment.last_status||'').toLowerCase(),delivered=shipment.active===false||status.includes('entregado'),released=status.includes('liberad');
    const actions=[['info','Información','']];
    if(can('documents.read'))actions.push(['documents','Documentos Cuba','']);
    actions.push(['edit','Editar',''],['history','Historial','']);
    if(!shipment.client_id)actions.push(['assign_client','Asignar cliente','orange']);
    if(shipment.shipsgo_status==='manual'){actions.push(['manual_update','Actualizar / corregir estado','']);actions.push([shipment.shipsgo_tracking_id?'resume_auto':'reconnect',shipment.shipsgo_tracking_id?'Volver a automático':'Reconectar ShipsGo','']);}
    else{if(!delivered)actions.push(['enable_manual','Cambiar a manual','']);if(shipment.shipsgo_status==='failed')actions.push(['reconnect','Reconectar ShipsGo','']);if(!released&&!delivered)actions.push(['release','Liberar','orange']);if(!delivered)actions.push(['deliver','Entregado','success']);}
    if(delivered)actions.push(['reactivate','Reactivar','success']); actions.push(['delete','Eliminar','danger']); return actions;
  }
  function ensureMenu(){
    let menu=byId('containerActionsPopover');if(menu)return menu;menu=document.createElement('div');menu.id='containerActionsPopover';menu.className='container-actions-popover hidden';document.body.appendChild(menu);
    document.addEventListener('click',event=>{if(!menu.classList.contains('hidden')&&!menu.contains(event.target)&&!menuTrigger?.contains(event.target))closeActionMenu();});window.addEventListener('resize',closeActionMenu);window.addEventListener('scroll',closeActionMenu,true);return menu;
  }
  ...
  function openActionMenu(shipment,trigger){
    const menu=ensureMenu();if(menuShipmentId===shipment.id&&!menu.classList.contains('hidden'))return closeActionMenu();closeActionMenu();menuShipmentId=shipment.id;menuTrigger=trigger;const actions=actionList(shipment);menu.innerHTML=actions.map(([key,label,cls],index)=>`${key==='delete'&&index?'<div class="container-actions-separator"></div>':''}<button type="button" class="${cls}" data-container-action="${key}">${esc(label)}</button>`).join('');menu.querySelectorAll('[data-container-action]').forEach(button=>button.onclick=async event=>{event.stopPropagation();const action=button.dataset.containerAction;closeActionMenu();try{await executeAction(shipment,action);}catch(error){alert(error.message);}});menu.classList.remove('hidden');positionMenu(menu,trigger);
  }
  ...
  function customsHtml(shipment,payload,error=''){
    if(!can('documents.read'))return '<section class="container-customs"><div class="container-customs-head"><div><h3>Documentos Cuba</h3><div class="container-customs-summary">No tienes permiso para consultar documentos del contenedor.</div></div></div><div class="container-customs-noaccess">Solicita acceso de solo lectura a Documentos para consultar readiness, archivos y versiones.</div></section>';
  ...
  async function uploadCustomsDocument(shipment,key){
    if(!can('documents.write'))return setCustomsFeedback('No tienes permiso para subir documentos.',false);
    const def=CUSTOMS_TYPES.find(x=>x.key===key);if(!def)return;
    const input=document.createElement('input');input.type='file';input.accept='.pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png,.webp';input.style.display='none';document.body.appendChild(input);
    input.onchange=async()=>{const file=input.files?.[0];input.remove();if(!file)return;let prepared=null;setCustomsFeedback('Preparando carga...',true);try{
      const result=await request('/api/shipment-documents',{method:'POST',body:JSON.stringify({action:'prepare_upload',shipment_id:shipment.id,document_type:def.key,file_name:file.name,mime_type:file.type,file_size_bytes:file.size})});prepared=result.upload;
      const form=new FormData();form.append('cacheControl','3600');form.append('',file);const storageResponse=await fetch(prepared.signed_url,{method:'PUT',headers:{'x-upsert':'false'},body:form});
      if(!storageResponse.ok){const detail=await storageResponse.text().catch(()=>'');await request('/api/shipment-documents',{method:'POST',body:JSON.stringify({action:'discard_upload',shipment_id:shipment.id,storage_path:prepared.storage_path})}).catch(()=>{});throw new Error(`No se pudo subir el archivo${detail?' · '+detail.slice(0,160):''}`);}
      const finalized=await request('/api/shipment-documents',{method:'POST',body:JSON.stringify({action:'finalize_upload',shipment_id:shipment.id,document_type:prepared.document_type,file_name:prepared.file_name,mime_type:prepared.mime_type,file_size_bytes:prepared.file_size_bytes,storage_path:prepared.storage_path})});
      await refreshAfterCustomsChange(shipment,finalized);setCustomsFeedback(`${def.label} actualizado correctamente.`,true);
    }catch(error){setCustomsFeedback(error.message||'No se pudo subir el documento.',false);}};input.click();
  }
  function confirmCustomsDelete(shipment,item){return new Promise(resolve=>{document.querySelector('.customs-confirm-overlay')?.remove();const overlay=document.createElement('div');overlay.className='customs-confirm-overlay';overlay.innerHTML=`<div class="customs-confirm-panel" role="dialog" aria-modal="true" aria-labelledby="customsConfirmTitle"><h3 id="customsConfirmTitle">Eliminar versión vigente</h3><p>Se retirará <b>${esc(item.file_name)}</b> del contenedor <b>${esc(shipment.container_number)}</b>. La versión quedará registrada en el historial como eliminada y, si era requerida, el contenedor volverá a pendiente.</p><div class="customs-confirm-actions"><button type="button" class="alt" data-customs-cancel>Cancelar</button><button type="button" class="danger" data-customs-confirm>Eliminar vigente</button></div></div>`;document.body.appendChild(overlay);const finish=value=>{overlay.remove();resolve(value);};overlay.querySelector('[data-customs-cancel]').onclick=()=>finish(false);overlay.querySelector('[data-customs-confirm]').onclick=()=>finish(true);overlay.onclick=event=>{if(event.target===overlay)finish(false);};});}
  async function deleteCustomsDocument(shipment,item){if(!can('documents.write'))return setCustomsFeedback('No tienes permiso para eliminar documentos.',false);if(!item?.is_current)return setCustomsFeedback('Solo puede retirarse la versión vigente.',false);if(!await confirmCustomsDelete(shipment,item))return;setCustomsFeedback('Eliminando versión vigente...',true);try{const result=await request('/api/shipment-documents',{method:'DELETE',body:JSON.stringify({document_id:item.id})});await refreshAfterCustomsChange(shipment,result);if(result.storage_cleanup_pending)setCustomsFeedback('Documento retirado del ERP. La limpieza física del archivo quedó pendiente para reintento.',false);else setCustomsFeedback('Versión vigente eliminada. El readiness fue recalculado.',true);}catch(error){setCustomsFeedback(error.message||'No se pudo eliminar el documento.',false);}}

  async function openDetails(shipment){
    const mode=modeLabel(shipment)[0],client=shipment.clients||{},importer=importerForShipment(shipment);let payload=null,error='',loadLink=null;
    if(can('documents.read')){try{payload=await loadShipmentDocuments(shipment);if(payload?.readiness)readinessByShipment.set(String(shipment.id),payload.readiness);}catch(e){error='No se pudieron cargar los documentos Cuba.';console.error('[tracking customs docs]',e);}}
  ...
  function showManualResult(result){const correction=result.correction_type==='rollback'?'Corrección guardada. ':'';if(result.notification_status==='not_requested')return alert(`${correction}Estado actualizado. No se envió WhatsApp.`);if(result.notification_status==='failed')return alert(`${correction}Estado actualizado, pero falló WhatsApp:\n${result.notification_error||'Error desconocido'}`);alert(`${correction}Estado actualizado${result.notification_status&&result.notification_status!=='unavailable_recipient'?' y notificación procesada.':'.'}`);}
  function openManualWorkflow(shipment){
    closeManualWorkflow();const currentIndex=currentEventIndex(shipment),currentLabel=currentIndex>=0?EVENTS[currentIndex].label:(shipment.last_status||shipment.operational_status||'Registrado'),defaultIndex=currentIndex>=0?currentIndex:0,hasRecipient=Boolean(shipment.client_id&&shipment.clients?.active&&shipment.clients?.phone);const overlay=document.createElement('div');overlay.className='manual-track-overlay';overlay.innerHTML=`<div class="manual-track-panel" role="dialog" aria-modal="true"><div class="manual-track-head"><div><h3>Actualizar / corregir tracking</h3><div class="muted">${esc(shipment.container_number)}</div></div><button type="button" class="manual-track-close">Cerrar</button></div><div class="manual-track-current-box"><small>Estado actual</small><br><b>${esc(currentLabel)}</b></div><div class="manual-track-list">${EVENTS.map((event,index)=>`<label class="manual-track-step ${index===currentIndex?'current selected':''}" data-index="${index}"><div class="manual-track-step-index">${index===currentIndex?'●':index+1}</div><div><div class="manual-track-step-title">${esc(event.label)}</div><div class="manual-track-step-note">${index===currentIndex?'Estado actual':'Disponible'}</div></div><input style="position:absolute;opacity:0" type="radio" name="manualTrackingEvent" value="${event.key}" ${index===defaultIndex?'checked':''}></label>`).join('')}</div><div class="manual-track-field"><label>Puerto o ubicación</label><input id="manualTrackingLocation" value="${esc(shipment.last_location||'')}"></div><label class="manual-track-notify ${hasRecipient?'':'disabled'}"><input id="manualTrackingNotify" type="checkbox" ${hasRecipient?'':'disabled'}><div><b>Enviar WhatsApp al cliente</b><span>Opcional. El estado se guarda aunque no envíes WhatsApp.</span></div></label><div id="manualTrackingWhatsappPreview" class="manual-track-preview hidden">Se enviará WhatsApp con el nuevo estado.</div><div class="manual-track-actions"><button type="button" class="manual-track-confirm">Guardar estado</button><button type="button" class="manual-track-cancel">Cancelar</button></div></div>`;document.body.appendChild(overlay);overlay.querySelector('.manual-track-close').onclick=closeManualWorkflow;overlay.querySelector('.manual-track-cancel').onclick=closeManualWorkflow;overlay.onclick=e=>{if(e.target===overlay)closeManualWorkflow();};overlay.querySelectorAll('.manual-track-step').forEach(step=>step.onclick=()=>{step.querySelector('input').checked=true;overlay.querySelectorAll('.manual-track-step').forEach(x=>x.classList.toggle('selected',x===step));});const notify=overlay.querySelector('#manualTrackingNotify'),preview=overlay.querySelector('#manualTrackingWhatsappPreview'),button=overlay.querySelector('.manual-track-confirm');notify?.addEventListener('change',()=>preview?.classList.toggle('hidden',!notify.checked));button.onclick=async()=>{const key=overlay.querySelector('input[name="manualTrackingEvent"]:checked')?.value,selected=EVENTS.find(x=>x.key===key);if(!selected)return;const send=Boolean(notify?.checked);if(!confirm(`¿Guardar “${selected.label}” para ${shipment.container_number}?${send?'\nTambién se enviará WhatsApp.':''}`))return;try{button.disabled=true;const result=await request('/api/manual-tracking-event',{method:'PATCH',body:JSON.stringify({id:shipment.id,event:selected.key,location:String(overlay.querySelector('#manualTrackingLocation')?.value||'').trim(),notify_whatsapp:send})});closeManualWorkflow();showManualResult(result);await window.loadAll?.();await window.loadNotifications?.();}catch(error){alert(error.message);button.disabled=false;}};
  }

  function openEditor(shipment,focus=null){if(!window.ShipmentEditor?.open)throw new Error('El editor de contenedores no está disponible.');window.ShipmentEditor.open(shipment.id,{focus});}
  async function deleteShipmentRecord(shipment){const confirmation=prompt(`Para eliminar definitivamente ${shipment.container_number}, escribe ELIMINAR`);if(confirmation!=='ELIMINAR')return;await request('/api/shipments?id='+encodeURIComponent(shipment.id),{method:'DELETE'});await window.loadAll?.();await loadReadiness();await window.loadNotifications?.();}
  async function executeAction(shipment,action){
    if(action==='info'||action==='documents')return openDetails(shipment);if(action==='history')return openHistory(shipment);if(action==='edit')return openEditor(shipment);if(action==='assign_client')return openEditor(shipment,'client');if(action==='manual_update')return openManualWorkflow(shipment);
    if(action==='enable_manual'){if(!confirm(`¿Cambiar ${shipment.container_number} a seguimiento manual?`))return;await request('/api/tracking-mode',{method:'PATCH',body:JSON.stringify({id:shipment.id,action:'enable_manual'})});return window.loadAll?.();}
    if(action==='resume_auto'){if(!confirm(`¿Volver ${shipment.container_number} a automático?`))return;await request('/api/tracking-mode',{method:'PATCH',body:JSON.stringify({id:shipment.id,action:'enable_auto'})});return window.loadAll?.();}
    if(action==='reconnect'){if(!confirm(`¿Reintentar ShipsGo para ${shipment.container_number}?`))return;await request('/api/shipments',{method:'PATCH',body:JSON.stringify({id:shipment.id,action:'retry_shipsgo'})});return window.loadAll?.();}
    if(['release','deliver','reactivate'].includes(action)){const labels={release:'liberar',deliver:'marcar como entregado',reactivate:'reactivar'};if(!confirm(`¿Confirmar ${labels[action]} ${shipment.container_number}?`))return;await request('/api/shipments',{method:'PATCH',body:JSON.stringify({id:shipment.id,action})});await window.loadAll?.();await loadReadiness();await request('/api/tracking-alerts?action=check').catch(()=>{});await window.loadNotifications?.();return;}
    if(action==='delete')return deleteShipmentRecord(shipment);
  }

  function bind(){
    byId('saveShipment')?.addEventListener('click',saveShipmentRecord);byId('shipmentSearch')?.addEventListener('input',render);document.querySelectorAll('[data-container-filter]').forEach(button=>button.addEventListener('click',()=>{activeFilter=button.dataset.containerFilter;document.querySelectorAll('[data-container-filter]').forEach(x=>x.classList.toggle('active',x===button));render();}));byId('shipments')?.addEventListener('click',event=>{const trigger=event.target.closest('[data-container-menu]');if(trigger){event.stopPropagation();const shipment=findShipment(trigger.dataset.containerMenu);if(shipment)openActionMenu(shipment,trigger);return;}const row=event.target.closest('[data-shipment-row]');if(!row||event.target.closest('button,a,input,select,textarea'))return;const shipment=findShipment(row.dataset.shipmentRow);if(shipment)openDetails(shipment);});
  }
