...
(() => {
  ...
  const accessStylesPromise = loadStylesheet('/admin/access-control.css?v=20260903-ux7access1', 'data-access-control-style');
  ...
  const bootAdminModules = () => {
    ...
    bootPromise = (async () => {
      ...
      await loadScript('/admin/access-control-administration.js?v=20260903-ux7access1', 'data-access-control-administration');
      ...
      if (accessCan('logistics.read')) {
        ...
        await loadScript('/admin/containers-module.js?v=20260904-owner-tracking1', 'data-containers-module');
      }
      ...
      if (accessCan('tasks.read')) {
        ...
        await loadScript('/admin/tasks-workspace.js?v=20260904-notification-entry1', 'data-tasks-workspace');
