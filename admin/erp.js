  ...
  const bootAdminModules = () => {
    ...
    bootPromise = (async () => {
      ...
      if (accessCan('logistics.read')) {
        await loadStylesheet('/admin/containers-module.css?v=20260902-ux7tracking1', 'data-containers-module-style');
        await loadScript('/admin/containers-module.js?v=20260902-ux7tracking1', 'data-containers-module');
      }
      if (accessCan('logistics.write')) {
        await loadStylesheet('/admin/shipment-editor.css?v=20260902-ux7tracking1', 'data-shipment-editor-style');
        await loadScript('/admin/shipment-editor.js?v=20260902-ux7tracking1', 'data-shipment-editor');
      }
