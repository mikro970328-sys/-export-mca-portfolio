...
function addLine(seed={},locked=editingLocks.structure===true){
  lineSeq++;const id=lineSeq,div=document.createElement('div'),pricingMode=hasEnteredLineTotal(seed)?'total':'unit',pricingValue=pricingMode==='total'?seed.entered_line_total:seed.unit_cost;div.className='line purchase-order-line';div.dataset.line=id;div.dataset.itemId=seed.id||'';div.dataset.pricingMode=pricingMode;
