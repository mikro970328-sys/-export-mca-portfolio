...
function closeModal(name){
  ...
  if(name==='order'){orderDraft?.destroy({flush:true});orderDraft=null;editing=null;repeatSource=null;editingLocks={};$('oSupplier').disabled=false;$('oDestinationMode').disabled=false;$('oWarehouse').disabled=false;$('oCurrency').disabled=false;$('addOrderLine').disabled=false;}if(name==='detail')detailOrder=null;if(name==='receive'){receiving=null;receivingMode='remaining';}if(name==='quickProduct')quickProductTarget=null;
  if(returnFocus instanceof HTMLElement)returnFocus.focus();
}
