...
function openOrder(order=null,repeatedOrder=null){
  ...
  $('orderTitle').textContent=order?`Editar ${order.po_number}`:repeatedOrder?`Repetir ${repeatedOrder.po_number}`:'Nueva Purchase Order';
