...
export default defineConfig({
  testDir: '.',
  testMatch: ['operators.spec.mjs','commercial.spec.mjs','direct-ship.spec.mjs','cancellation-finance.spec.mjs','navigation-startup.spec.mjs','repeat-purchase.spec.mjs'],
  fullyParallel: false,
  workers: 1,
  retries: 0,
  timeout: 180_000,
